        ...
        jb1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(Name.equals("")||PassWord.equals("")){
					...
					//使用服务器公钥加密账号密码
					Name  = EncryptionUtils.encryptStringByPublicKey("publicKey.key", Name);
					
					//先使用sha对密码进行加密
					try {
						PassWord = ShaUtils.encryptSHA(PassWord);
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
					PassWord = EncryptionUtils.encryptStringByPublicKey("publicKey.key", PassWord);
					System.out.println("注册加密后： \nname: " + Name + "\n password: " + PassWord);
