...
public interface MessageType {
	...
	public String Send_FileToAll = "@Send_FileToAll";//加密的方式发送文件给所有人
	public String Send_FileToAll_without_encry = "@Send_FileToAll_without_encry";//不加密的方式发送文件给所有人
	public String Send_FileToPerson = "@Send_FileToPerson";//加密的方式发送文件给个人
	public String send_FileToPerson_without_encry = "@@Send_FileToPerson_without_encry";//不加密的方式发送文件给个人
