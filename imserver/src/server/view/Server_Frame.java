...
import server.backstage.ServerConClient;
import server.backstage.ServerManage;
...
public class Server_Frame extends JFrame{
	...
	public Server_Frame(){
	    ...
	    jla1.setBounds(470, 30, 80, 20);
	    c.add(jla1);
	    
	    jla2 = new JLabel("0");
	    jla2.setBounds(540, 30, 30, 20);
	    c.add(jla2);
		...
		jsp1.setBounds(10, 50, 450, 200);
		c.add(jsp1);
		
		jl = new JList(onLine);
		jsp2 = new JScrollPane(jl);
		jsp2.setBounds(465, 50, 120, 285);
		c.add(jsp2);
		
		jta2 = new JTextArea();
		jta2.setEditable(false);
		jsp3 = new JScrollPane(jta2);
		jsp3.setBounds(10, 255, 450, 80);
		c.add(jsp3);
