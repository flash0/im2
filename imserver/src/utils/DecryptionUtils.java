...
public class DecryptionUtils {
	 ...
	 * @throws Exception 
	 */
	public static void decryptMessage(String filePrivateKeyName,Message message) throws Exception{
		/*
		 * 服务器端解密客户端发送过来的消息步骤:
		 * 	1.获取发送过来消息里的KEY
		...
		//解密AES密钥后进行hash
		message.setGetKeyMac(ShaUtils.encryptSHA(new String(key)));
	...
	public static Message getAES(String filePrivateKeyName,Message message) throws Exception{
